...
public class OperationClass {
		...
		public void insert_record() throws ClassNotFoundException, SQLException {
			...
			String countStatus = "select max(ID) from Shukla";
			...
			String insertQuery = "insert into Shukla values(?,?,?,?,?)";
           ...
           public void delete() throws ClassNotFoundException, SQLException {
        	   ...
        	   String studentUID = sc.next();
        		String searchQuery = "select * from Shukla where studentsUID=?";
        		con=conObject.getConnection();
    			...
    			if(rs.next()) {
    				...
    				if (reply==1) {
    					String deleteQuery="delete from Shukla where studentsUID=?";
           ...
           public void update() throws ClassNotFoundException, SQLException {
   			...
   			String updatedQuery = "update Shukla set studentsCourse=? where studentsUID=?";
...
public void display_All() throws ClassNotFoundException, SQLException {
	...
	String searchQuery = "select * from Shukla";
	con = conObject.getConnection();
	PreparedStatement psmt1 = con.prepareStatement(searchQuery);
